...
const toastVariants = cva(
  "group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-lg border p-4 pr-8 shadow-elevation-3 transition-all duration-300",
  {
    variants: {
      variant: {
      ...
      >
        <div className="flex items-start space-x-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            {description && (
              <div className="text-body-sm opacity-90 mt-1">
                {description}
              </div>
            )}
            {children}
